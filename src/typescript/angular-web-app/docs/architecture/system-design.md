...
Angular application system architecture and design patterns.
...
│   │   │   └── mock-oauth.service.ts # OAuth mock
│   │   ├── app.routes.ts         # Route configuration
│   │   ├── app.component.ts      # Root component
│   │   └── app.config.ts         # Application configuration
│   ├── assets/                   # Static resources
│   ├── styles.css                # Global styles (300+ utility classes)
...
// Core authentication logic, no external HTTP dependencies
```
