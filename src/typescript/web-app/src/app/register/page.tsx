 ...
 *
 * Provides both email/password registration and OAuth registration options
 */
export default function RegisterPage() {
  ...
  const handleOAuthRegister = async (
    ...
    try {
      // Simulate OAuth registration by redirecting to mock OAuth flow
      window.location.href = `/api/auth/mock-oauth?provider=${provider}&action=register`
    } catch (error: any) {
      setErrors({
        general:
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-neutral-600">
            Join thousands of users already collaborating on SyncCoreAI
          </p>
        </div>
            ...
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  ...
                  {errors.agreeToTerms && (
                    <p id="terms-error" className="text-error-500 text-xs mt-1">
                      {errors.agreeToTerms}
                    </p>
                  )}
                </div>
