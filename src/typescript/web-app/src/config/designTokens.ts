/**
 * Design Tokens for SyncCoreAI Web App
 *
 * This file contains the core design tokens that will be used throughout the application.
 * These tokens are designed to be compatible with a future Design System integration.
 *
 * Structure:
 * - Colors: Primary, secondary, neutral, semantic colors
 * - Typography: Font sizes, weights, line heights
 * - Spacing: Margin, padding, gaps
 * - Sizing: Width, height, max/min sizes
 * - Border Radius: Corner radii for different elements
