const { designTokens } = require('./src/config/designTokens.js')
...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      // Custom colors using design tokens + shadcn/ui compatibility
      colors: {
        // Design token colors
        ...designTokens.colors,
      ...
      animation: {
        ...
        'slide-out-to-top': 'slide-out-to-top 0.25s ease-out',
      },
    },
  },
